actor MotivationLetter {
    ...
    var message : Text = "I want to build a decentralized application (dApp) on the Internet Computer using Motoko, leveraging canisters for scalability and efficiency.";
